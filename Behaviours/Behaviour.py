...
class Behaviour:
    ...
    def onDeath(self,gameObject:EntityType,map:MapType,dt:float,game:GameType): ...
    def onTriggerEnter(self,gameObject:EntityType,other:EntityType,game:GameType): ...
    def onTriggerStay(self,gameObject:EntityType,other:EntityType,game:GameType): ...
    def onTriggerLeave(self,gameObject:EntityType,other:EntityType,game:GameType): ...